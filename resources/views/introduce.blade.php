      ...
      <div class="row mt-2 card-deck">
             <div class="col-md-4 card-deck">
                <div class="card p-3" style="width:300px">
                    ...
                    <img class="card-img-top" src="frontend/image/gt/gt1.jpg" alt="Card image">
                    <div class="mb-2">
             ...
             <div class="col-md-4 card-deck">
                <div class="card  p-3" style="width:300px">
                    ...
                    <img class="card-img-top" src="frontend/image/gt/gt2.jpg" alt="Card image">
                    <div class="mb-2">
             ...
             <div class="col-md-4 card-deck">
                <div class="card card-deck p-3" style="width:300px">
                    ...
                    <img class="card-img-top" src="frontend/image/gt/gt3.jpg" alt="Card image">
                    <div class="mb-2">
      ...
      <div class="row card-deck">
        <div class="col-md-4 card-deck">
           <div class="card p-3" style="width:300px">
               ...
               <img class="card-img-top" src="frontend/image/gt/gt4.jpg" alt="Card image">
               <div class="mb-2">
        ...
        <div class="col-md-4 card-deck">
           <div class="card  p-3" style="width:300px">
               ...
               <img class="card-img-top" src="frontend/image/gt/gt5.jpg" alt="Card image">
               <div class="mb-2">
        ...
        <div class="col-md-4 card-deck">
           <div class="card card-deck p-3" style="width:300px">
               ...
               <img class="card-img-top" src="frontend/image/gt/gt6.jpg" alt="Card image">
               <div class="mb-2">
