      ...
      <tbody>
       ...
       <tr>
        <td>
           {{ $product->productName }} 
        <td>
             <div class="product-image-thumb" ><img src="/upload/{{ $product->productImage1 }}" alt="Product Image"></div>
             @if ($product->productImage2 != null)
             <div class="product-image-thumb" ><img src="/upload/{{ $product->productImage2 }}" alt="Product Image"></div>
             @endif
             @if ($product->productImage3 != null)
             <div class="product-image-thumb" ><img src="/upload/{{ $product->productImage3 }}" alt="Product Image"></div>       <td>
            {{ $product->brand }} 
        </td>
