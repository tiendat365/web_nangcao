...
<div class="container jumbotron bg-white">
  <div class="row ">
    ...
    <img src="/upload/{{ $product->productImage }}" alt="" style="" class="xzoom" xoriginal="upload/{{ $product->productImage }}">
  </div>
  <div class="img_sp_chitiet xzoom-thums">
              <a href="upload/{{ $product->productImage }}" class="card">
                <img src="/upload/{{ $product->productImage }}" xpreview="upload/{{ $product->productImage }}" class="xzoom-gallery">
              </a>
              @if (isset($prodetail->productImage1))
              <a href="upload/{{ $prodetail->productImage1 }}" class="card">
                <img src="/upload/{{ $prodetail->productImage1 }}" class="xzoom-gallery">
              </a>
              @endif
              @if (isset($prodetail->productImage2))
              <a href="upload/{{ $prodetail->productImage2 }}" class="card">
                <img src="/upload/{{ $prodetail->productImage2 }}" class="xzoom-gallery">   
              </a>
              @endif
              @if (isset($prodetail->productImage3))
              <a href="upload/{{ $prodetail->productImage3 }}" class="card">
                <img src="/upload/{{ $prodetail->productImage3 }}" class="xzoom-gallery">
              </a>
              @endif
            </div>
...
<div class="col-sm-8">
  ...
  <div class=" d-flex ml-5 pb-4" style="border-bottom: solid 1px rgba(145, 145, 145, 0.404);">
    ...
    <div class="p-2 ml-5">
      <img src="frontend/a.png" alt="" class="mb-2" style="height: 25px;">
...
<p class="time">New</p>
<div class="img-box">
<img src="/upload/{{ $pro->productImage }}">
</div>
