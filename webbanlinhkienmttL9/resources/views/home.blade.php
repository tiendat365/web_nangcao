 ...
 <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
   ...
   <div class="carousel-inner">
     <div class="carousel-item active">
       <img class="d-block w-100" src="upload/{{ $slide->slide }}" alt="First slide">
     </div>
   @foreach ($slides as $item)
   <div class="carousel-item">
    <img class="d-block w-100" src="upload/{{ $item->slide1 }}">
  </div>
   @endforeach
     ...
     <div class="row ">
      ...
      <div class="col-md-3 col-sm-6 col-12">
          <div class="card card-product">
            <img class="card-img-top" src="./upload/{{ $product->productImage }}" alt="Card image cap">
            <div class="card-body">
...
<img src="frontend/image/icon/Capture.PNG" alt=""   class="mb-3"> 
...
<div class="row bg-white" >
  <div class="product-group">
    <div class="row ">
      ...
      <div class="col-md-3 col-sm-6 col-12">
          <div class="card card-product">
            <img class="card-img-top" src="./upload/{{ $item->productImage }}" alt="Card image cap">
            <div class="card-body">
              <h6 class="card-title product-title mb-3">
                <a  data-toggle="tooltip" data-placement="bottom" title="
                {{ $item->productName }}"> 
