...
<div class="container jumbotron   border border-success">
    ...
    <table class="table">
      ...
      <tbody>
               <tr> 
                   <td><div class="" ><img src="/upload/{{ $slide->slide }}" alt="Product Image" style="width: 300px;"></div></td>
           ...
           <tr>
            <td><div class="" ><img src="/upload/{{ $item->slide1 }}" alt="Product Image" style="width: 300px;"></div></td>
